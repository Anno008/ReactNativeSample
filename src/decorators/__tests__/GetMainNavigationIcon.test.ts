...
describe("GetMainNavigationIcon tests", (): void => {
    it("Should render the provided icon", (): void => {
        const mockProps: TabScene = {
            focused: false,
            index: 1,
            route: {} as unknown as NavigationRoute,
            tintColor: "blue"
        };
    ...
    it("Should render icon with width and height set to 30 if focused", (): void => {
        const mockProps: TabScene = {
            focused: true,
            index: 1,
            route: {} as unknown as NavigationRoute,
    ...
    it("Should render icon with width and height set to 24 if not focused", (): void => {
        const mockProps: TabScene = {
            focused: false,
            index: 1,
            route: {} as unknown as NavigationRoute,
    ...
    it("Should render icon with provided tint color if it exists in props", (): void => {
        const mockProps: TabScene = {
            focused: false,
            index: 1,
            route: {} as unknown as NavigationRoute,
    ...
    it("Should render icon with fallback tint color if it does not exists in props", (): void => {
        const mockProps: TabScene = {
            focused: false,
            index: 1,
            route: {} as unknown as NavigationRoute,
